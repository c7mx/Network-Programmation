...
class Battle4:
    ...
    def __init__(self, general1: General, general2: General, general3: General  ,general4: General , battlefield: Battlefield, view:View = None, datafile: str = None):
        """
    ...
    def start(self,is_tourney=False):
        ...
        while running:
            ...
            if not self.paused and self.winner is None:
                ...
                for _ in range(self.speed):
                    ...
                    self.general3.play(self.battlefield)
                    if self.logger:
                        self.logger.log_info_from_general(self.general3, self.battlefield)

                    self.general4.play(self.battlefield)
                    if self.logger:
                        self.logger.log_info_from_general(self.general4, self.battlefield)

                    self.battlefield.update(dt)

                if self.general1.is_defeated(self.battlefield) and self.general3.is_defeated(self.battlefield) and self.general4.is_defeated(self.battlefield):
                    self.winner = self.general2
                    if self.view is None:
                        running = False
                elif self.general2.is_defeated(self.battlefield) and self.general3.is_defeated(self.battlefield) and  self.general4.is_defeated(self.battlefield):
                    self.winner = self.general1
                    if self.view is None:
                        running = False
                elif self.general2.is_defeated(self.battlefield) and self.general1.is_defeated(self.battlefield) and self.general4.is_defeated(self.battlefield):
                    self.winner = self.general3
                    if self.view is None:
                        running = False
                elif self.general2.is_defeated(self.battlefield) and self.general1.is_defeated(self.battlefield) and self.general3.is_defeated(self.battlefield):
                    self.winner = self.general4
                    if self.view is None:
                        running = False
                ...
                if self.collectStats:
                    ...
                    axis_y[2].append(self.general3.get_unit_alive_number(self.battlefield))
                    axis_y[3].append(self.general4.get_unit_alive_number(self.battlefield))
        ...
        if self.collectStats:
            plot(
                ...
                "Time (frames)",
                "Remaining Units",
                [self.general1.strategy, self.general2.strategy , self.general3.strategy, self.general4.strategy],
                show=True,
            ...
            if event.type == pygame.QUIT:
                ...
                #---------------------------------- SWITCH VIEW (Q) ------------------------------------------
                    ...
                    if isinstance (self.view, GUI):
                        ...
                        pygame.display.quit()
                        self.view = GUI(self.battlefield, [self.general1, self.general2, self.general3 , self.general4], False)
    ...
    def _apply_loaded_battle(self, loaded_battle):
        ...
        self.general3 = loaded_battle.general3
        self.general4 = loaded_battle.general4
        ...
        if self.view:
            ...
            if hasattr(self.view, "generaux"):
                self.view.generaux = [self.general1, self.general2, self.general3 , self.general4]
