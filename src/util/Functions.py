...
def create_parser():
    ...
    This function defines all available commands (`multi` and `run4`) along with their required and optional arguments.
    ...
    run4_p = subparsers.add_parser('run4', help='Run a battle between four AIs')
